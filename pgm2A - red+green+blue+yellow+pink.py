...
# Program Name: pgm2A-red+green+blue+yellow+pink.py
# Purpose: Solution to Programming Exercises Q3
# Display a red, green, blue, yellow and pink square on a black background
...
rectangle = pygame.Rect(150, 0, 50, 50)
pygame.draw.rect(display_surface, (255,255,0), rectangle) #yellow
rectangle = pygame.Rect(0, 50, 50, 50)
pygame.draw.rect(display_surface, (255,0,255), rectangle) #pink
