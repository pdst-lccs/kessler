# Program 6 - squares moving independently bouncing off world edges
...
# Program Name: pgm6A-parsons problem.py
# Purpose: Solution to programming task 6 (Parson's problem)
# This program simulates multiple all squares moving independently bouncing off world edges
