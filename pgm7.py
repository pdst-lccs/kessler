...
# Program Name: pgm7.py
# Purpose: Solution to programming task 7
# This program to simulate multiple squares all moving independently ....
# ... the squares can detect collisions and react by bouncing off each other
    ...
    for satellite in satellites:
        ...
        for sat in satellites:
            ...
            if sat['sprite'] != rectangle and rectangle.colliderect(sat['sprite']):
                ...
                satellite['move_left'] = not satellite['move_left'] # True; random.choice([True,False])
                satellite['move_down'] = not satellite['move_down'] # True; random.choice([True,False])
